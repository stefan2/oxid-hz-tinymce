...
browser.baseGetData = function(act) {
     ...
     * @OXID
     *
     * @TODO Warum muß hier das &amp; ersetzt werden?
     *       Wenn vorhanden wird ausgeloggt.
     *
     * [Original]
     * var data = 'browse.php?type=' + encodeURIComponent(this.type) + '&lng=' + this.lang;
     */
    if( browser._url ) {
        var data = browser._url.replace(/&amp;/g,'&') + 'type=' + encodeURIComponent(this.type) + '&lng=' + this.lang;
    } else {
        var data = window.location.href + '&type=' + encodeURIComponent(this.type) + '&lng=' + this.lang;
    }
